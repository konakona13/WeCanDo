...
public class KendoJoinController {
	...
	public String guestPayAction(Model model,GuestPayCommand guestPayCommand, KendoJoinCommand kendoJoinCommand) {
		System.out.println("guestPayDetail");
		path = kendoJoinService.guestPayDetail(model, guestPayCommand, kendoJoinCommand);
		return path;		
	}
