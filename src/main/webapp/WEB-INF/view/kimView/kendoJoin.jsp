...
<body>
        ...
        <form name="frm" action="kendoJoinAction" method="POST">
            <table>
                ...
                <tr>
                    <td>이름 </td>
                    <td><input type=hidden name = "memberName"/>비타민씨</td>
                </tr>
                <tr>
                    <td>연락처 </td>
                    <td><input type=hidden name = "memberPh"/>010777888</td>
                </tr>
                <tr>
                    <td>나이 </td>
                    <td><input type=hidden name = "memberAge"/>11</td>
                </tr>
                <tr>
                    <td>성별 </td>
                    <td><input type=hidden name = "gender"/>여</td>
                </tr>
                <tr>
                    <td>주소 </td>
                    <td><input type=hidden name = "memberAddr"/>서울 ~~</td>
                </tr>
                <tr>
                    <td>이메일 </td>
                    <td><input type=hidden name = "memberEmail"/>vitaminc@gmail.com</td>
                </tr>
                <tr>
                    <td>신청수량 </td>
